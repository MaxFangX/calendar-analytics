...
class ColorCategoryDetailEventTimeSeries(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response(category.get_time_series(self.request.query_params.get('timezone'), time_step=self.kwargs['time_step'].lower()))
...
class TagDetailEventTimeSeries(APIView):
    ...
    def get(self, request, *args, **kw):
        tag = Tag.objects.get(user=self.request.user, id=self.kwargs['pk'])
        return Response(tag.get_time_series(self.request.query_params.get('timezone'), time_step=self.kwargs['time_step'].lower()))
