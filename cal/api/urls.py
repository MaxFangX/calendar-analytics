...
urlpatterns = patterns(
    ...
    url(r'^v1/colorcategories/(?P<pk>[0-9]+)/eventMonth/?$', views.ColorCategoryDetailEventMonth.as_view()),
    url(r'^v1/colorcategories/(?P<pk>[0-9]+)/eventDay/?$', views.ColorCategoryDetailEventDay.as_view()),
    ...
    url(r'^v1/tags/(?P<pk>[0-9]+)/eventMonth/?$', views.TagDetailEventMonth.as_view()),
    url(r'^v1/tags/(?P<pk>[0-9]+)/eventDay/?$', views.TagDetailEventDay.as_view()),
